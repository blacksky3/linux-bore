...
source=(https://mirrors.edge.kernel.org/pub/linux/kernel/v5.x/linux-$pkgver.tar.xz
        ...
        # BORE patch
        https://raw.githubusercontent.com/blacksky3/patches/main/5.17/bore/0001-5.17.y-bore1.3.30.0.patch
        https://raw.githubusercontent.com/blacksky3/patches/main/5.17/bore/0001-peterz-sched-patches-2-3-8.patch
        # AMD patches
        ...
        # Wine
        ${patchpath}/wine/0007-v5.18-winesync.patch
        # Graysky2 CPU patch
...
_package(){
  pkgdesc='The Linux kernel and modules with Masahito Suzuki BORE CPU scheduler, AMD, Arch, Block, CPU, BTRFS, Futex, Wine and kernel_compiler_patch patch'
