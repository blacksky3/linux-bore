...
#Credits: Masahito Suzuki <firelzrd@gmail.com> <https://github.com/firelzrd/bore-scheduler> ---> For BORE (Burst-Oriented Response Enhancer) CPU Scheduler patch
...
_package(){
  pkgdesc='The Linux kernel and modules with Masahito Suzuki BORE CPU scheduler patch and Piotr Górski Arch patches'
