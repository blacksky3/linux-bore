...
#Credits: Masahito Suzuki <firelzrd@gmail.com> <https://github.com/firelzrd/bore-scheduler>
...
_package(){
  pkgdesc='The Linux kernel and modules with Masahito Suzuki BORE CPU scheduler patch, Piotr Górski Arch, Block and CPU patches, XanMod CPU Power patch and Graysky2 kernel_compiler_patch patch'
